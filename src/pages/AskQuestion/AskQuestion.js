...
const AskQuestion = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // console.log({questionTitle, questionBody, questionTags, userPosted: User.result.name, userId: User.result._id})
        dispatch(askQuestion({ questionTitle, questionBody, questionTags, userPosted: User.user.name, userEmail: User.user.email }, navigate))
    }
